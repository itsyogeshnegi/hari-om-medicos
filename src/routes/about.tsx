...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Learn about MediCare Plus — India's trusted online pharmacy with licensed pharmacists, genuine medicines and 24-hour delivery." },
    ],
  }),
  component: () => (
    <div className="container-px mx-auto max-w-5xl py-12">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
        {[
          [Users, "2M+", "Happy customers"],
          [Truck, "50+", "Cities served"],
          [ShieldCheck, "100%", "Genuine medicines"],
          [HeartPulse, "24/7", "Pharmacist support"],
        ].map(([Icon, n, l]: any) => (
      ...
      <div className="prose prose-neutral max-w-none mt-12 space-y-4 text-foreground">
        <h2 className="font-display font-bold text-2xl">Our story</h2>
        <p className="text-muted-foreground">Founded in 2024, MediCare Plus was born from a simple frustration — finding the right medicine shouldn't be hard. Today we operate licensed warehouses across India, partner with the country's top manufacturers and employ certified pharmacists who verify every single order.</p>
